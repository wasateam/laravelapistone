...
/**
 * @group SocialiteFacebookAccount
 *
 * @authenticated
 *
 * APIs for SocialiteFacebookAccount
 */
class SocialiteFacebookAccountController extends Controller
{
   ...
   * Show
   *
   * @urlParam  socialite_facebook_account required The ID of socialite_facebook_account. Example: 1
   */
   ...
   * Delete
   *
   * @urlParam  socialite_facebook_account required The ID of socialite_facebook_account. Example: 2
   */
