...
class CreatePocketFileVersionsTable extends Migration
{
  /**
   * Run the migrations.
   *
  ...
  public function up()
  {
    Schema::create('pocket_file_versions', function (Blueprint $table) {
      $table->id();
      $table->timestamps();
      $table->softDeletes();
      $table->integer('pocket_file_id');
  ...
  {
    Schema::dropIfExists('pocket_file_versions');
  }
}
