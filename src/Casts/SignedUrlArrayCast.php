...
class SignedUrlArrayCast implements CastsAttributes
{
  /**
  ...
  public function get($model, $key, $value, $attributes)
  {
    ...
    foreach ($_value as $value_key => $value_item) {
      $_value[$value_key] = StorageHelper::get_signed_url_by_link($value_item);
    }
    return $_value;
  }
  ...
  public function set($model, $key, $value, $attributes)
  {
    ...
    foreach ($_value as $value_key => $value_item) {
      $_value[$value_key] = StorageHelper::get_store_data_by_url($value_item);
    }
