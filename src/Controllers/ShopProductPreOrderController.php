...
/**
 * @group ShopProductPreOrder
 *
 * @authenticated
 *
 * APIs for shop_product_pre_order
 */
class ShopProductPreOrderController extends Controller
{
  public $model                   = 'Wasateam\Laravelapistone\Models\ShopProduct';
  public $name                    = 'shop_product_pre_order';
  public $resource                = 'Wasateam\Laravelapistone\Resources\ShopProductPreOrder';
  public $resource_for_collection = 'Wasateam\Laravelapistone\Resources\ShopProductPreOrderCollection';
  public $input_fields            = [
    'type',
    'no',
    'name',
